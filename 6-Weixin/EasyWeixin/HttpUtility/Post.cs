...
namespace EasyWeixin.HttpUtility
{
    public static class Post
    {
        ...
        {
            string returnText = RequestUtility.HttpPost(url, cookieContainer, fileName, encoding);
        ...
        {
            string returnText = RequestUtility.HttpPost(url, cookieContainer, fileStream, false, encoding);
            var result = GetResult<T>(returnText);
            return result;
        }
