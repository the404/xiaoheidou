...
namespace EasyWeixin.AdvancedAPIs.QrCode
{
    ...
    public static class QrCodeApi
    {
        ...
        /// <param name="expireSeconds">该二维码有效时间，以秒为单位。 最大不超过604800。(他这里只是这样来封装的)0时为永久二维码</param>
        /// <param name="sceneId">场景值ID，临时二维码时为32位整型，永久二维码时最大值为1000</param>
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static CreateQrCodeResult Create(string accessToken, string sceneId, int expireSeconds = 604800)
        {
