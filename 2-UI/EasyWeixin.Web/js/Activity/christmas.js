...
window.onload = function () {
    ...
    btnSave.onclick = function () {
        ...
        if (Phone == "" || UserName == "") {
            ...
            $.post("/ActivitySnow/SaveSnowGameData", { datas: JSON.stringify(savedatas), UserName: UserName, Phone: Phone, SnowID: $("#SnowID").val() }, function (data) {
                alert(data.Message);
                location.href = "/ActivitySnow/SnowRank?SnowID=" + $("#SnowID").val();
            });
        }
    }
