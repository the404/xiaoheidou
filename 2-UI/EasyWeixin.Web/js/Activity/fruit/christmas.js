/*
 * Author   :蔡应
 * Time		:2014年3月25日9:20:32
 * Abstract	:苏州乐园微信游戏——水果切切切
 */
...
window.onload = function () {
    ...
    btnSave.onclick = function () {
        ...
        if (Phone == "" || UserName == "" || CardId == "") {
            ...
            $.post("/ActivityFruit/SaveSnowGameData", { datas: JSON.stringify(savedatas), UserName: UserName, Phone: Phone, CardId: CardId, SnowID: $("#SnowID").val() }, function (data) {
                alert(data.Message);
                location.href = "/ActivityFruit/FruitIndex?SnowID=" + $("#SnowID").val();
            });
        }
    }
    ...
    timerSnow = setInterval(function () {
        ...
        oSnowBox.innerHTML += '<li style="background-image:url(../images/Activity/Fruit/fruit_0' + z + '.png);"><span></span></li>';
