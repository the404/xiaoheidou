...
namespace EasyWeixin.Web.Controllers
{
    ...
    public class FruitController : Controller
    {
        ...
        public FruitController(ISnowItemRepository SnowItemRepository, ISnowRepository SnowRepository, ISnowUserRepository SnowUserRepository, IResponseImageTextRepository ResponseImageTextRepository, IUserProfileRepository UserProfileRepository)
        {
        ...
        public ActionResult FruitIndex(int pageid = 1)
        {
            var UserId = WebSecurity.GetUserId(User.Identity.Name);
            var Snow = SnowRepository.FindAll(Specification<Snow>.Eval(o => o.UserId == UserId)).Where(o => o.Mark == 2).ToList();
        ...
        public ActionResult FruitCreate()
        {
            return View();
        }
        ...
        public ActionResult FruitEdit(Guid id)
        {
        ...
        [ValidateInput(false)]
        [ValidateAntiForgeryToken]
        public ActionResult FruitEdit(SnowViewModel form)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult FruitDelete(Guid id)
        {
            ...
            return RedirectToAction("FruitIndex");
        }

        #endregion 删除
        #region

        public ActionResult FruitUserList(Guid SnowID, int pageid = 1, DateTime? dt1 = null, DateTime? dt2 = null)
        {
            try
            {
                int guesscount = 0;
        ...
        public ActionResult FruitItemIndex(int SnowID)
        {
        ...
        public ActionResult FruitItemEdit(int SnowID, Guid? ID = null)
        {
            if (ID == null)
            {
        ...
        [HttpPost]
        public JsonResult FruitItemEdit(SnowItem form)
        {
        ...
        public ActionResult FruitItemDelete(Guid id)
        {
            var SnowItem = SnowItemRepository.GetByKey(id);
            int SnowID = SnowItem.Snow.SnowID;
            SnowItemRepository.Remove(SnowItem);
            SnowItemRepository.Context.Commit();
            return Redirect("/Fruit/FruitItemIndex?SnowID=" + SnowID);
        }
