...
{
    public class ActivityFruitController : Controller
    {
        //苏州水果切切
        // GET: /ActivityFruit/
        ...
        public ActivityFruitController(ISnowLogRepository SnowLogRepository,
        ...
        /// <returns></returns>
        public ActionResult FruitIndex(Guid SnowID, string UserWexinID = "")
        {
        ...
        /// <returns></returns>
        public ActionResult FruitRank(Guid SnowID, string UserWexinID = "")
        {
            var Snow = SnowRepository.GetByKey(SnowID);
        ...
        /// <summary>
        /// 水果切切游戏 有四种奖励 日日夜，日夜，苏州乐园马克纪念杯，指定日免费入场
        /// 由于奖品起初设定的是一个月，奖品的数量正好是一天两个，所以将日票和夜票归于一类，杯子和报纸归于一类
        /// </summary>
        /// <param name="SnowID"></param>
        /// <param name="UserWexinID"></param>
        /// <returns></returns>
        public ActionResult FruitGame(Guid SnowID, string UserWexinID = "")
        {
            var snow = SnowRepository.GetByKey(SnowID);
            if (DateTime.Now < snow.StartDate || DateTime.Now > snow.EndDate.AddDays(1))
            {
